...
class ProviderRegistry:
    """Provider registry with no bridge-local credential authority.

    Credential-bearing external provider classes are fail-closed until an
    admitted TV/TVC provider route is supplied by the canonical owner.
    Local/mock providers remain ordinary local providers.
    """
